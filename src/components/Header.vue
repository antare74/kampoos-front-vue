                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-5 d-none d-md-block">
                            <form class="searc-wrap">
                                <div class="input-group w-100">
                                    <input type="text" class="form-control search-form" style="width:55%;border 1px solid #ffffff" name="q" placeholder="mau beli apa hari ini ?">
                        ...
                        <div class="col-md-4 col-5">
                            <div class="d-flex justify-content-end">
                                ...
                                <div class="account">
                                    ...
                                    <router-link :to="{name: 'dashboard'}" class="btn search-button btn-md d-none d-md-block ml-4"><i class="fa fa-tachometer-alt"></i>DASHBOARD</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
